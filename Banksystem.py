...
if __name__ == "__main__":
    ...
    print("************************************************************")
    print("==========     (1). Login to Client Account     ============")
    ...
    if user == 1:
        ...
        while True:
            if Bank_object.loggedin:
                ...
                # print("5.Logout")
                print("************************************************************")
                print("========== WELCOME BACK TO ITSOURCECODE BANKING SYSTEM ==========")
                print("************************************************************")
                print("==========     (1). Add amount to Client Account       ============")
                print("==========     (2). Check Balance of Client Account    ============")
                print("==========     (3). Transfer Amount to another Client  ============")
                print("==========     (4). Edit profile of Client Account     ============")
                print("==========     (5). Logout                             ============")
                print("************************************************************")
